const questions = [
    ...
    },
    {
        ...
        choices: [{answer:"AWS Config", value: 1}, 
        {answer:"AWS OpsWorks", value:2}, {answer:"AWS SDK",value:3}, {answer:"AWS Marketplace", value: 4}],
        correctValue:4,
    ...
    },
    {
        ...
        choices : [{answer:"AWS Regions", value:1},
         {answer:"Edge locations", value:2}, 
         {answer:"Availability Zones", value:3}, {answer:"Virtual Private Cloud (VPC)", value:4}],
        correctValue: 2,
    ...
    },
    {
        ...
        choices: [{answer:"Use Amazon Cloud Directory", value:1}, 
        {answer:"Audit AWS Identity and Access Management (IAM) roles", value:2}, 
        {answer:"Enable multi-factor authentication", value:3}, 
        {answer:"Enable AWS CloudTrail", value:4}],
        correctValue: 3,
    ...
    },
    {
        ...
        choices: [{answer:"AWS Trusted Advisor", value:1}, 
        {answer:"AWS CloudTrail", value:2}, 
        {answer:"AWS X-Ray",value:3}, {answer:"AWS Identity and Access Management (AWS IAM)", value:4}],
        correctValue: 2,
    ...
    },
    {
        ...
        choices: [{answer:"Amazon Simple Notification Service (Amazon SNS)", value:1},
        {answer:"AWS CloudTrail", value:2},{answer:"AWS Trusted Advisor", value:3},{answer:"Amazon Route 53",value:4}],
        correctValue: 1,
    ...
    },
    {
        ...
        choices:[{answer:"AWS Trusted Advisor",value:1}, 
        {answer:"AWS Identity and Access Management (IAM)", value:2}, 
        {answer:"AWS Billing Console", value: 3}, {answer:"AWS Acceptable Use Policy",value:4}],
        correctValue: 4,
